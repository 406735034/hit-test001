  ...
  q(
    ...
    function (e, l, g, k, q, f) {
      ...
      var v = f.addEvent,
        ...
        N = /firefox/i.test(F);
      z(k.lang, {
        viewFullscreen: "全屏查看", //view in fullscreen
        exitFullscreen: "從全屏退出", // Exit from full screen
        printChart: " 打印圖表", //Print chart
        downloadPNG: "下載 PNG 圖片", //Download PNG image
        downloadJPEG: "下載PNG圖片", //Download JPEG image
        downloadPDF: "下載PDF文件", //Download PDF document
        downloadSVG: "下載 SVG向量 圖片", //Download SVG vector image
        contextButtonTitle: "圖表上下文菜單", //Chart context menu
      });
